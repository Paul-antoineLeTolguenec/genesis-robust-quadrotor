"""Tests for category 7 — payload & configuration perturbations.

Covers: U1–U11 unit tests, I1–I3 integration tests.
All 3 perturbations are stateless + per_episode → U8/U10 skipped automatically.
7.1/7.2 are GenesisSetterPerturbation → I2 applies, I3 skipped.
7.3 is ExternalWrenchPerturbation → I3 applies, I2 skipped.
"""
...
# ---------------------------------------------------------------------------
# U8 — stateful persistence (skipped — all Cat 7 are stateless)
# ---------------------------------------------------------------------------
